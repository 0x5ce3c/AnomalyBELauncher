...
#    define __in_isspace std::isspace
...
#else
        s.erase(s.begin(), std::find_if(s.begin(), s.end(), [](int ch) { return !__in_isspace(ch); }));
        //s.erase(s.begin(), std::find_if(s.begin(), s.end(), std::not1(std::not_fn(static_cast<int(*)(int)>(__in_isspace))));
#endif
        return s;
    }
...
#else
        s.erase(std::find_if(s.rbegin(), s.rend(), [](int ch) { return !__in_isspace(ch); }).base(), s.end());
        //s.erase(std::find_if(s.rbegin(), s.rend(), std::not1(std::not_fn(static_cast<int(*)(int)>(__in_isspace))).base(), s.end());
#endif
        return s;
    }
    ...
    **/
    ...
    public:
        ...
        bool AsFloat() const { return Get<float>(); }
